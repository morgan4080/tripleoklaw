	      ...
	      <div class="col-md-12">
	        ...
	        <div class="box box-primary">
	          <div class="box-header with-border">
	            <h3 class="box-title">Create new section content for {{ $section_name }} on {{ $page_name }}</h3>
	          </div>
	    		@include('includes.messages')      
	          <!-- /.box-header -->
	          <!-- form start -->
	          <form role="form" name="myForm" action="{{ route('content.store') }}" method="post" enctype="multipart/form-data">
	          {{ csrf_field() }}
	          ...
	          <input type="hidden" id="section_id" name="section_id" value="{{ $section_id }}">
	            ...
	            <div class="col-lg-offset-3 col-lg-6">
	              <div class="form-group">
	                ...
	                <textarea rows="4" cols="90" class="form-control" id="content_title" name="content_title" placeholder="Content Title"></textarea>
	              </div>
	              <div class="form-group">
	                <label for="name">Content Subtitle</label>
	                <textarea rows="4" cols="90" class="form-control" id="content_subtitle" name="content_subtitle" placeholder="Content Sub - Title"></textarea>
	              </div>
	              <div class="form-group">
	              ...
	              <div class="form-group">
	                ...
	                <textarea rows="8" cols="90" class="form-control" id="description_one" name="description_one" placeholder="Content Description"></textarea>
	              </div>
	              <div class="form-group">
	                <label for="name">Content Description Two</label>
	                <textarea rows="8" cols="90" class="form-control" id="description_two" name="description_two" placeholder="Content Description"></textarea>
	              </div>
