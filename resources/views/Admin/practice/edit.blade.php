      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <form role="form" action="{{ route('practice.update',$practice->practice_id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
              <div class="col-lg-6">
                   <input type="hidden" name="practice_id" value="{{$practice->practice_id}}">
             ...
             <div class="form-group" style="margin-top:18px;">
                                ...
                                <option value="{{$practice->pracategory_id}}" selected>{{$practice->pracategory_name}}</option>
                            ...
                            <br>
                              <div class="form-group">
                                <div class="pull-right">
                                  <label for="banner_image">Practice Banner Image</label>
