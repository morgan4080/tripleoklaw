            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" name="type" placeholder="e.g Internship">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="title">Question 1</label>
                  <input type="text" class="form-control" id="title" name="questions[]" placeholder="some question">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
