...
<html data-wf-page="5d24a0a2a07f787f8033d1ca" data-wf-site="5d12117a5cf1540428d8d090">
...
<div class="contai">
    <div class="w-row" style="margin-top: 5vh; margin-bottom: 5vh;">
        <div class="column-15 w-col w-col-6">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1994.4024490346774!2d36.810833203848304!3d-1.2914139871448616!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xceb08d40213d55b!2sTRIPLEOKLAW+LLP!5e0!3m2!1sen!2ske!4v1566473870676!5m2!1sen!2ske" width="674" height="330" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
        <div class="w-col w-col-6">
            <div class="container-2 w-container">
                <div class="div-block-12"><img src="{{asset('images/TripleOKlaw-Logo-copy2.png')}}" alt=""></div>
                <div>
                    <div class="columns-5 w-row">
                        <div class="column-14 w-col w-col-1"><img src="{{asset('images/location_1location.png')}}" alt=""></div>
                        <div class="w-col w-col-11">
                            <div class="contacts-text">5th Floor, Wing C, ACK Garden House, 1st Ngong’ Avenue, off Bishops Road<br>P.O. Box 43170-00100, <br>Nairobi, Kenya<br>‍</div>
                        </div>
                    </div>
                    <div class="columns-5-copy w-row">
                        <div class="column-14 w-col w-col-1"><img src="{{asset('images/phone_1phone.png')}}" alt=""></div>
                        <div class="w-col w-col-11">
                            <div class="contacts-text">T - +254 (20)272 7171, 271 1533   271 7186<br>C - +254 (0)709 830 100<br></div>
                        </div>
                    </div>
                    <div class="columns-5-copy w-row">
                        <div class="column-14 w-col w-col-1"><img src="{{asset('images/mail_1mail.png')}}" alt=""></div>
                        <div class="w-col w-col-11">
                            <div class="contacts-text">info@tripleoklaw.com</div>
                        </div>
                    </div>
                </div>
            </div>
