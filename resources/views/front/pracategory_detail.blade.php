   ...
   <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
     <div class="w-row">
      ...
      <div class="column-25 w-col w-col-7 w-col-tiny-6">
        <nav role="navigation" class="nav-menu w-nav-menu"><a href="/about" class="nav-link w-nav-link">about us</a><a href="/team" class="w-nav-link">TEAM</a><a href="/pracategory" class="w-nav-link">pracategorys</a><a href="/perspective" class="w-nav-link">PERSPECTIVE</a><a href="/join" class="w-nav-link">JOIN US</a><a href="/contact" class="w-nav-link">CONTACT US</a></nav>
    ...
    <div class="w-row">
      ...
      <div class="column-20-copy w-col w-col-3">
        <div class="text-block-35">Other subcategories</div>
         @foreach($relatedCategories as $all)
