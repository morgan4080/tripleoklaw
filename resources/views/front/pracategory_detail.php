...
<head>
  <meta charset="utf-8">
  <title>{{$pracategory->pracategory_name}}</title>
  <meta content="pracategory" property="og:title">
...
<body>
   <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
     <div class="w-row">
      ...
      <div class="column-25 w-col w-col-7 w-col-tiny-6">
        <nav role="navigation" class="nav-menu w-nav-menu">
            ...
            <a href="/team" class="w-nav-link">TEAM</a>
            <a href="/practice" class="w-nav-link">practicese</a>
            <a href="/perspective" class="w-nav-link">PERSPECTIVE</a>
            <a href="/join" class="w-nav-link">JOIN US</a>
            <a href="/contact" class="w-nav-link">CONTACT US</a>
        </nav>
    ...
    <div class="div-block-6-dispute"style="background-image: url({{asset('uploads/'.$pracategory->pracategory_banner_image)}})">
      <div class="text-block-16">{{$pracategory->pracategory_name}}</div>
    </div>
  </div>
  <div>
    <div class="w-row">
      <div class="column-19 w-col w-col-9">
        <div class="w-container">
          <div class="text-block-32">{{$pracategory->pracategory_name}}}</div>
          <div class="columns-8 w-row">
            <div class="column-18 w-col w-col-1 w-col-tiny-tiny-stack">
            ...
            <div class="w-col w-col-11">
              <div class="text-block-33">{!!html_entity_decode($pracategory->pracategory_introduction)!!}</div>
            </div>
          </div>
        </div>
      </div>
      <div class="column-20-copy w-col w-col-3">
        <div class="text-block-35">Other subcategories</div>
         @foreach($relatedPracategories as $all)
          ...
          <div><a href="/team_detail/{{$team->team_slug}}" class="link-block-3 w-inline-block"><img src="{{asset('uploads/'.$team->team_image)}}" alt=""></a>
            <a href="/team_detail/{{$team->team_slug}}" class="link-block-4 w-inline-block">
              <div class="div-block-7">
                ...
                <div class="text-block-18-copy">{{$team->pracategory_name}}<br></div>
    ...
    <div class="columns-9 w-row">
      ...
      <div class="w-col w-col-2">
        <div>
          ...
          <div class="div-block-13"><a href="/pracategory" class="link-3">pracategoryS</a></div>
