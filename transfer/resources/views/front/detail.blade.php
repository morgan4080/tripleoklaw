  ...
  <div class="header-image">
    <div class="single-page-image modal-parent">
      <div class="columns-14 w-row">
        <div class="column-16 w-col w-col-5">
          <div>
            ...
            <div class="text-block-29">
                {{$personDetails->team_email}}<br><br>+254 2 2727 171
            </div>
        ...
        <div class="column-17 w-col w-col-4"><img src="{{asset('/uploads/'.$personDetails->inner_team_image)}}" alt=""></div>
          ...
          <div class="w-container">
            ...
            <div class="columns-8 w-row">
              <div class="column-18 w-col w-col-1">
               <div class="social-icons"><a href="{{$personDetails->team_linkedin}}" target="_blank" class="link-block-6-copy13 w-inline-block"><img src="{{asset('images/linkedin3_1linkedin3.png')}}" alt="" class="image-8"></a><a href="{{$personDetails->team_twitter}}" target="_blank" class="link-block-14 w-inline-block"><img src="{{asset('images/twitter3_1twitter3.png')}}" alt="" class="image-9"></a><a href="mailto:{{$personDetails->team_email}}" class="link-block-15 w-inline-block"><img src="{{asset('images/mail3_1mail3.png')}}" alt="" class="image-10"></a><a href="https://api.whatsapp.com/send?phone={{$personDetails->phone_number}}" class="link-block-16 w-inline-block"><img src="{{asset('images/WA-Logo3_1WA Logo3.png')}}" alt="" class="image-11"></a></div>
              </div>
    ...
    <div class="other-specialists">
      <div class="text-block-39">OTHER SPECIALISTS</div>
          ...
          <div><a href="/team_detail/{{$team->team_slug}}" class="link-block-3 w-inline-block"><img src="{{asset('uploads/'.$team->team_image)}}" alt=""></a>
            <a href="/team_detail/{{$team->team_slug}}" class="link-block-4 w-inline-block">
              <div class="div-block-7">
                ...
                <div class="text-block-18-copy">{{$team->practice_name}}<br></div>
