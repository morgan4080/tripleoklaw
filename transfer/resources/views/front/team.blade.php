    ...
    <div data-duration-in="300" data-duration-out="100" class="w-tabs">
      <div class="tabs-menu w-tab-menu">
        ...
        <a data-w-tab="Tab 2" class="tab-link-tab-2 w-inline-block w-tab-link">
          <div class="text-block-26">PEOPLE</div>
        </a>
        <a data-w-tab="Tab 3" class="tab-link-tab-3 w-inline-block w-tab-link">
          <div class="text-block-27">MANAGEMENT</div>
        </a>
      </div>
                ...
                @foreach ($allPeople->chunk(4) as $chunk)
                    <div class="columns-3 w-row">
                        @foreach ($chunk as $people)
                            <div class="w-col w-col-3">
                                <div><a href="/team_detail/{{$people->team_slug}}" class="link-block-3 w-inline-block"><img src="{{asset('uploads/'.$people->team_image)}}" alt=""></a>
