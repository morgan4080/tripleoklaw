...
class TeamController extends Controller
{
    ...
    {
        $teams=DB::table('practices')
         ->join('teams', 'practices.practice_id', '=', 'teams.practice_id')->get();
    ...
    public function edit($id)
    {
        $team=DB::table('practices')
         ->join('teams', 'practices.practice_id', '=', 'teams.practice_id')->where('team_id', $id)->first();
        $practices =Practice::all();
